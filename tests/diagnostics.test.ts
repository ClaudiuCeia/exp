...
test("formatCaret renders a snippet with caret", () => {
...
test("formatCaret restricts snippet to the error line", () => {
  const input = "aa\nbbcc\ndd";
...
test("formatDiagnosticReport renders unicode arrow with message", () => {
...
test("formatDiagnosticReport renders multispan underline with centered arrow", () => {
